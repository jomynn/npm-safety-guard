...
exports.MALICIOUS_DB = [
    ...
    // ─── Classic / Historical Attacks (examples) ──────────────────────────────
    {
        ...
        description: "Malicious maintainer added flatmap-stream dependency targeting Copay " +
    ...
    },
    {
        ...
        description: "Maintainer intentionally introduced code that wiped files on systems " +
...
function checkDependencies(deps) {
    ...
    for (const [name, version] of Object.entries(deps)) {
        ...
        if (entry)
            hits.push({ name, version, entry });
    }
    return hits;
}
//# sourceMappingURL=maliciousDb.js.map